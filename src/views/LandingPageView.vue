    ...
    <nav class="navbar navbar-expand-lg navbar-light fixed-top shadow-sm" id="mainNav">
        <div class="container px-5">
            <a class="navbar-brand fw-bold" href="#page-top">
                <img src="/assets/img/Logo-panjang.png">
            </a>
                    ...
                    <div class="card">
                        <div class="card-body shadow">
                            <div class="card-container">
                                <div class="row mt-5">
                                    <div class="img-card">
                                        <img class="img-card-inside" src="/assets/img/card-img-1.png">
                                    </div>
                                </div>
                                <div class="row">
                    ...
                    <div class="card">
                        <div class="card-body shadow">
                            <div class="card-container">
                                <div class="row mt-5">
                                    <div class="img-card">
                                        <img class="img-card-inside" src="/assets/img/card-img-2.png">
                                    </div>
                                </div>
                                <div class="row">
                                    <div class="txt-card mt-3">
                    ...
                    <div class="card">
                        <div class="card-body shadow">
                            <div class="card-container">
                                <div class="row mt-5">
                                    <div class="img-card">
                                        <img class="img-card-inside" src="/assets/img/card-img-3.png">
                                    </div>
                                </div>
                                <div class="row">
                                    <div class="txt-card mt-3">
            ...
            <div class="row">
                <div class="col-sm-6">
                    ...
                    <div class="container-before-footer">
                        <h2 class="header-text lh-1 mb-3">- Contact Info -</h2>
                        <h5 class="contact-info text-white mt-2"><a class="a" href="https://wa.me/+62882003365621"><svg
                                ...
                                </svg> +62882003365621</a></h5>
                        <h5 class="contact-info text-white"><a class="a" href="https://instagram.com/sentus.id"><svg
                                    xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor"
                        ...
                        <h5 class="contact-info text-white"><a class="a" href="https://goo.gl/maps/THbKPf5wQeMtyJu49?coh=178573&entry=tt"><svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-pin-map" viewBox="0 0 16 16">
  <path fill-rule="evenodd" d="M3.1 11.2a.5.5 0 0 1 .4-.2H6a.5.5 0 0 1 0 1H3.75L1.5 15h13l-2.25-3H10a.5.5 0 0 1 0-1h2.5a.5.5 0 0 1 .4.2l3 4a.5.5 0 0 1-.4.8H.5a.5.5 0 0 1-.4-.8l3-4z"/>
  <path fill-rule="evenodd" d="M8 1a3 3 0 1 0 0 6 3 3 0 0 0 0-6zM4 4a4 4 0 1 1 4.5 3.969V13.5a.5.5 0 0 1-1 0V7.97A4 4 0 0 1 4 3.999z"/>
</svg> Universitas Negeri Surabaya - Kampus Ketintang</a></h5>
                    </div>
                </div>
                <div class="col-sm-6 ">
                    <iframe
